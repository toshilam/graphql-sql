...
(function() {
	...
	var p = VOEvent.prototype = Object.create( gsql.ApplicationEvent.prototype);
	...
	p.clone = function() 
	{
		return new gsql.VOEvent(this.type, this.targetDisplayObject, this.data, this.propertyName, this.propertyValue);
	}
