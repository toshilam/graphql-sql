...
( function() {
	...
	var Timer = function(inInterval, inCount) 
	{
		...
		{
			throw 'Timer : unable to initialize gsql.Timer!';
		}
	...
	p.start = function()
	{
		...
		{
			var that = this;
			var TimerEvent = gsql.TimerEvent;
			...
			//gsql.Tracer.echo('Timer : start : ' + this._timerID);
			return true;
		}
		
		gsql.Tracer.echo('Timer : start : fail : timer is running or no data is set!');
		return false;
	}
	
	p.stop = function()
	{
		//gsql.Tracer.echo('Timer : stop : ' + this._timerID);
