...
(function() {
	...
	var p = ServiceEvent.prototype = Object.create( ocs.ApplicationEvent.prototype);
	...
	p.initialize = function(type, inServiceResponse, inData, inTarget) 
	{
		...
		if (inData instanceof ocs.ResultVO) this._result = inData;
	}

	p.clone = function() 
	{
		return new ocs.ServiceEvent(this.type, this._response, this._result);
	}
